...
implements Queue<T> {
    ...
    static final AtomicLongFieldUpdater<are> c = AtomicLongFieldUpdater.newUpdater((Class)are.class, (String)"b");
    static final AtomicLongFieldUpdater<are> k = AtomicLongFieldUpdater.newUpdater((Class)are.class, (String)"j");
    ...
    public are(int n2) {
        ...
        int n3 = arn.a(Math.max((int)8, (int)n2));
        int n4 = n3 - 1;
    ...
    private T a(AtomicReferenceArray<Object> atomicReferenceArray, long l2, int n2) {
        this.i = atomicReferenceArray;
        int n3 = are.a(l2, n2);
        Object object = are.a(atomicReferenceArray, n3);
        if (object == null) {
            return null;
        }
        super.b(1 + l2);
        are.a(atomicReferenceArray, n3, null);
        return (T)object;
    }

    private AtomicReferenceArray<Object> a(AtomicReferenceArray<Object> atomicReferenceArray) {
        return (AtomicReferenceArray)are.a(atomicReferenceArray, are.b(-1 + atomicReferenceArray.length()));
    }
    ...
    private void a(AtomicReferenceArray<Object> atomicReferenceArray, long l2, int n2, T t2, long l3) {
        ...
        this.e = l2 + l3 - 1;
        this.a(l2 + 1);
        are.a(atomicReferenceArray2, n2, t2);
        this.a(atomicReferenceArray, atomicReferenceArray2);
        are.a(atomicReferenceArray, n2, l);
    }

    private void a(AtomicReferenceArray<Object> atomicReferenceArray, AtomicReferenceArray<Object> atomicReferenceArray2) {
        are.a(atomicReferenceArray, are.b(-1 + atomicReferenceArray.length()), atomicReferenceArray2);
    }

    private boolean a(AtomicReferenceArray<Object> atomicReferenceArray, T t2, long l2, int n2) {
        super.a(1 + l2);
        are.a(atomicReferenceArray, n2, t2);
        return true;
    }
    ...
    private T b(AtomicReferenceArray<Object> atomicReferenceArray, long l2, int n2) {
        this.i = atomicReferenceArray;
        return (T)are.a(atomicReferenceArray, are.a(l2, n2));
    }
    ...
    public final boolean offer(T t2) {
        ...
        int n4 = this.d;
        if (are.a(atomicReferenceArray, are.a(l2 + (long)n4, n2)) == null) {
            this.e = l2 + (long)n4 - 1;
            return super.a(atomicReferenceArray, t2, l2, n3);
        }
        if (are.a(atomicReferenceArray, are.a(1 + l2, n2)) != null) {
            return super.a(atomicReferenceArray, t2, l2, n3);
        }
    ...
    public final T peek() {
        ...
        long l2 = this.d();
        Object object = are.a(atomicReferenceArray, are.a(l2, n2 = this.h));
        if (object == l) {
