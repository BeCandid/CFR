...
extends IInterface {
    ...
    public void init(aag var1) throws RemoteException;

    public static abstract class abw$a
    extends Binder
    implements abw {
        public abw$a() {
        ...
        public static abw asInterface(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof abw) {
                return (abw)iInterface;
            }
        ...
        public boolean onTransact(int n2, Parcel parcel, Parcel parcel2, int n3) throws RemoteException {
            switch (n2) {
                ...
                case 1: {
                    ...
                    this.init(aag.a.a(parcel.readStrongBinder()));
        ...
        implements abw {
             ...
             */
            @Override
            public void init(aag aag2) throws RemoteException {
                Parcel parcel = Parcel.obtain();
                Parcel parcel2 = Parcel.obtain();
                try {
                    parcel.writeInterfaceToken("com.google.android.gms.flags.IFlagProvider");
