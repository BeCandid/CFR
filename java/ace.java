...
public class ace {
     ...
     */
    public ace(Context context, int n2, String string2) {
    ...
    public ace(Context context, int n2, String string2, String string3, String string4) {
     ...
     */
    @SuppressLint(value={"UnwrappedWakeLock"})
    public ace(Context context, int n2, String string2, String string3, String string4, String string5) {
        this.k = true;
        xz.a(string2, (Object)"Wake lock name can NOT be empty");
        this.f = n2;
        this.h = string3;
        this.i = string5;
...
lbl8: // 2 sources:
        ...
        {
            zk.a().a(this.j, zi.a(this.d, var3_3), 8, this.g, var3_3, this.i, this.f, zx.b(this.e));
            this.m = -1 + this.m;
        }
        // MONITOREXIT : var6_4
    }
...
lbl9: // 2 sources:
        ...
        {
            zk.a().a(this.j, zi.a(this.d, var5_4), 7, this.g, var5_4, this.i, this.f, zx.b(this.e), var2_2);
            this.m = 1 + this.m;
        }
        // MONITOREXIT : var8_5
    }
