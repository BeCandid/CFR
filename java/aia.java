...
public class aia {
    ...
    protected aia(Context context, String string2, Bundle bundle) {
     ...
     */
    public static aia a(Context context, Bundle bundle) {
        reference var9_2 = aia.class;
        synchronized (aia.class) {
            ...
            aia aia2 = (aia)a.get((Object)string4);
            if (aia2 == null) {
                aia2 = new aia(context2, string4, bundle);
                a.put((Object)string4, (Object)aia2);
            }
