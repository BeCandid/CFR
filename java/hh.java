...
extends RecyclerView.Adapter<a> {
    ...
    public a a(ViewGroup viewGroup, int n2) {
        return new a(LayoutInflater.from((Context)viewGroup.getContext()).inflate(2130968690, viewGroup, false));
    }
    ...
    public void a(a a2, int n2) {
        ...
        jt<int> jt2 = GossipApplication.c.a(groupSearchResult.thumbUrl).a().a((String)((int)17301613));
        kr[] arrkr = new kr[]{this.c};
        jt2.a(arrkr).a(a2.b);
    }
    ...
    extends RecyclerView.ViewHolder {
        ...
        a(View view) {
            super(view);
            this.a = (TextView)view.findViewById(2131624503);
            this.b = (ImageView)view.findViewById(2131624501);
            this.c = (TextView)view.findViewById(2131624502);
        }
    }
