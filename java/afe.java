...
extends IInterface {
    ...
    public boolean a(afe var1) throws RemoteException;
    ...
    public static abstract class afe$a
    extends Binder
    implements afe {
        public static afe a(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof afe) {
                return (afe)iInterface;
            }
        ...
        public boolean onTransact(int n2, Parcel parcel, Parcel parcel2, int n3) throws RemoteException {
            switch (n2) {
                ...
                case 19: {
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    boolean bl4 = this.a(afe$a.a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    int n7 = 0;
                    if (bl4) {
                        n7 = 1;
        ...
        implements afe {
             ...
             */
            @Override
            public boolean a(afe afe2) throws RemoteException {
                Parcel parcel = Parcel.obtain();
                Parcel parcel2 = Parcel.obtain();
                try {
                    parcel.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
