...
extends IInterface {
    ...
    public LatLng a(aag var1) throws RemoteException;

    public VisibleRegion a() throws RemoteException;

    public static abstract class adn$a
    extends Binder
    implements adn {
        public static adn a(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof adn) {
                return (adn)iInterface;
            }
        ...
        public boolean onTransact(int n2, Parcel parcel, Parcel parcel2, int n3) throws RemoteException {
            switch (n2) {
                ...
                case 1: {
                    ...
                    LatLng latLng = this.a((aag)aag.a.zzbs((IBinder)parcel.readStrongBinder()));
        ...
        implements adn {
             ...
             */
            @Override
            public LatLng a(aag aag2) throws RemoteException {
                Parcel parcel = Parcel.obtain();
                Parcel parcel2 = Parcel.obtain();
                try {
                    parcel.writeInterfaceToken("com.google.android.gms.maps.internal.IProjectionDelegate");
