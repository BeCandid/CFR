...
extends arf<E> {
    ...
    static {
        if (8 == asd.a.arrayIndexScale((Class)long[].class)) {
            f = 3 + a;
            e = asd.a.arrayBaseOffset((Class)long[].class) + (32 << f - a);
            return;
        }
    ...
    protected final long a(long[] arrl, long l2) {
        return asd.a.getLongVolatile((Object)arrl, l2);
    }

    protected final void a(long[] arrl, long l2, long l3) {
        asd.a.putOrderedLong((Object)arrl, l2, l3);
    }
