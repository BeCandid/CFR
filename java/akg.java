...
public final class akg {
    ...
    private akg(byte[] arrby, int n2, int n3) {
        this.a = arrby;
        this.b = n2;
        this.c = n2 + n3;
        this.e = n2;
    ...
    public static akg a(byte[] arrby) {
        return akg.a(arrby, 0, arrby.length);
    }

    public static akg a(byte[] arrby, int n2, int n3) {
        return new akg(arrby, n2, n3);
    }
    ...
    public void a(aki aki2) throws IOException {
        int n2 = this.f();
        if (this.h >= this.i) {
