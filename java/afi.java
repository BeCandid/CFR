...
extends IInterface {
    ...
    public boolean a(afi var1) throws RemoteException;
    ...
    public static abstract class afi$a
    extends Binder
    implements afi {
        public static afi a(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof afi) {
                return (afi)iInterface;
            }
        ...
        public boolean onTransact(int n2, Parcel parcel, Parcel parcel2, int n3) throws RemoteException {
            switch (n2) {
                ...
                case 8: {
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    boolean bl4 = this.a(afi$a.a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    int n6 = 0;
                    if (bl4) {
                        n6 = 1;
        ...
        implements afi {
             ...
             */
            @Override
            public boolean a(afi afi2) throws RemoteException {
                Parcel parcel = Parcel.obtain();
                Parcel parcel2 = Parcel.obtain();
                try {
                    parcel.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    IBinder iBinder = afi2 != null ? afi2.asBinder() : null;
