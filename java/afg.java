...
extends IInterface {
    ...
    public boolean a(afg var1) throws RemoteException;
    ...
    public static abstract class afg$a
    extends Binder
    implements afg {
        public static afg a(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof afg) {
                return (afg)iInterface;
            }
        ...
        public boolean onTransact(int n2, Parcel parcel, Parcel parcel2, int n3) throws RemoteException {
            switch (n2) {
                ...
                case 16: {
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    boolean bl7 = this.a(afg$a.a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    int n9 = 0;
                    if (bl7) {
                        n9 = 1;
        ...
        implements afg {
             ...
             */
            @Override
            public boolean a(afg afg2) throws RemoteException {
                Parcel parcel = Parcel.obtain();
                Parcel parcel2 = Parcel.obtain();
                try {
                    parcel.writeInterfaceToken("com.google.android.gms.maps.model.internal.IMarkerDelegate");
