...
implements akr {
    ...
    public void a(TooltipView tooltipView, Canvas canvas) {
        ...
        rectF.top += (float)tooltipView.getArrowHeight();
        ...
        float f2 = akq.a(tooltipView, rectF);
        tooltipView.getTooltipPath().moveTo(f2, 0.0f);
        int n2 = tooltipView.getArrowWidth() / 2;
        tooltipView.getTooltipPath().lineTo(f2 - (float)n2, rectF.top);
        tooltipView.getTooltipPath().lineTo(f2 + (float)n2, rectF.top);
