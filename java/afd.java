...
extends IInterface {
    ...
    public boolean a(afd var1) throws RemoteException;
    ...
    public static abstract class afd$a
    extends Binder
    implements afd {
        public static afd a(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof afd) {
                return (afd)iInterface;
            }
        ...
        public boolean onTransact(int n2, Parcel parcel, Parcel parcel2, int n3) throws RemoteException {
            switch (n2) {
                ...
                case 17: {
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.ICircleDelegate");
                    boolean bl4 = this.a(afd$a.a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    int n8 = 0;
                    if (bl4) {
                        n8 = 1;
        ...
        implements afd {
             ...
             */
            @Override
            public boolean a(afd afd2) throws RemoteException {
                Parcel parcel = Parcel.obtain();
                Parcel parcel2 = Parcel.obtain();
                try {
                    parcel.writeInterfaceToken("com.google.android.gms.maps.model.internal.ICircleDelegate");
                    IBinder iBinder = afd2 != null ? afd2.asBinder() : null;
