...
implements Closeable {
    ...
    static {
        ajb.a = new ajb(){
            ...
            @Override
            public void a(ajv ajv2) throws IOException {
                if (ajv2 instanceof ajk) {
                    ((ajk)ajv2).o();
                    return;
                }
                int n2 = ajv2.a;
                ...
                throw new IllegalStateException("Expected a name but was " + (Object)ajv2.f() + " " + " at line " + ajv2.r() + " column " + ajv2.s() + " path " + ajv2.t());
            }
        };
    }

    public ajv(Reader reader) {
        int[] arrn = this.m;
        int n2 = this.n;
        this.n = n2 + 1;
        arrn[n2] = 6;
