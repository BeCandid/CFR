...
extends IInterface {
    ...
    public boolean a(aff var1) throws RemoteException;
    ...
    public static abstract class aff$a
    extends Binder
    implements aff {
        public static aff a(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof aff) {
                return (aff)iInterface;
            }
        ...
        public boolean onTransact(int n2, Parcel parcel, Parcel parcel2, int n3) throws RemoteException {
            switch (n2) {
                ...
                case 5: {
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                    boolean bl3 = this.a(aff$a.a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    int n7 = 0;
                    if (bl3) {
                        n7 = 1;
        ...
        implements aff {
             ...
             */
            @Override
            public boolean a(aff aff2) throws RemoteException {
                Parcel parcel = Parcel.obtain();
                Parcel parcel2 = Parcel.obtain();
                try {
                    parcel.writeInterfaceToken("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                    IBinder iBinder = aff2 != null ? aff2.asBinder() : null;
