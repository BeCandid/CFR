...
extends aha.a {
    ...
    public ahl(ahk ahk2, boolean bl2) {
        xz.a(ahk2);
        this.a = ahk2;
        this.b = bl2;
    }
    ...
    public List<UserAttributeParcel> a(final AppMetadata var1, boolean var2_2) {
        super.c(var1);
        var3_3 = this.a.h().a((Callable)new Callable<List<agn>>(){

            public List<agn> a() throws Exception {
                ahl.this.a.J();
                return ahl.this.a.o().a(var1.b);
            }
        ...
        try {
            ...
            while (var7_6.hasNext() != false) {
                var8_7 = (agn)var7_6.next();
                if (!var2_2 && ago.j(var8_7.b)) continue;
...
lbl-1000: // 2 sources:
    ...
    public void a(final AppMetadata appMetadata) {
        ...
        this.a.h().a(new Runnable(){
            ...
            public void run() {
                ahl.this.a.J();
                ahl.this.a(appMetadata.h);
                ahl.this.a.b(appMetadata);
            }
        });
    }
    ...
    public void a(final EventParcel eventParcel, final AppMetadata appMetadata) {
        ...
        this.a.h().a(new Runnable(){
            ...
            public void run() {
                ahl.this.a.J();
                ahl.this.a(appMetadata.h);
                ahl.this.a.a(eventParcel, appMetadata);
            }
        });
    }
    ...
    public void a(final EventParcel eventParcel, final String string2, final String string3) {
        ...
        this.a.h().a(new Runnable(){
            ...
            public void run() {
                ahl.this.a.J();
                ahl.this.a(string3);
                ahl.this.a.a(eventParcel, string2);
            }
        });
    }
    ...
    public void a(final UserAttributeParcel userAttributeParcel, final AppMetadata appMetadata) {
        ...
        if (userAttributeParcel.a() == null) {
            this.a.h().a(new Runnable(){
                ...
                public void run() {
                    ahl.this.a.J();
                    ahl.this.a(appMetadata.h);
                    ahl.this.a.b(userAttributeParcel, appMetadata);
                }
            });
            return;
        }
        this.a.h().a(new Runnable(){
            ...
            public void run() {
                ahl.this.a.J();
                ahl.this.a(appMetadata.h);
                ahl.this.a.a(userAttributeParcel, appMetadata);
            }
        });
    }
    ...
    public byte[] a(final EventParcel var1, final String var2_2) {
        ...
        var7_4 = this.a.h().b((Callable)new Callable<byte[]>(){
            ...
            public byte[] a() throws Exception {
                ahl.this.a.J();
                return ahl.this.a.b(var1, var2_2);
            }
...
lbl-1000: // 2 sources:
    ...
    protected void b(String string2) throws SecurityException {
        ...
        if (zw.a(this.a.q(), n2, string2) || zw.a(this.a.q(), n2) && !this.a.C()) {
            return;
        }
