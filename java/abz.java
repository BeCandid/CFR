    ...
    extends aau {
        ...
        public b b(aas aas2) throws IOException {
            block9 : do {
                ...
                int n7 = aaw.b(aas2, 50);
                int n8 = this.g == null ? 0 : this.g.length;
                aby.a[] arra = new aby.a[n7 + n8];
                if (n8 != 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (!aat.a(this.e, b2.e)) {
                return false;
            }
            if (!aat.a(this.f, b2.f)) {
                return false;
            }
            if (aat.a(this.g, b2.g)) return true;
            return false;
        }
        ...
        public int hashCode() {
            ...
            int n8 = 0;
            if (n7 == null) {
                return 31 * (31 * (31 * (n6 + n8) + aat.a(this.e)) + aat.a(this.f)) + aat.a(this.g);
            }
            n8 = this.d.hashCode();
            return 31 * (31 * (31 * (n6 + n8) + aat.a(this.e)) + aat.a(this.f)) + aat.a(this.g);
        }
    ...
    extends aau {
        ...
        public c b(aas aas2) throws IOException {
            block5 : do {
                ...
                switch (n2) {
                    default: {
                        if (aaw.a(aas2, n2)) continue block5;
                    }
                    case 0: {
                        return this;
                    }
