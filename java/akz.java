...
class akz
implements Callable<Map<String, ale>> {
    final String a;
     ...
     */
    private ale a(ZipEntry zipEntry, ZipFile zipFile) {
        ...
        try {
            ...
            try {
                ...
                akx.h().e("Fabric", "Error when parsing fabric properties " + zipEntry.getName(), (Throwable)var5_8);
                return null;
            }
            ale ale2 = new ale(string3, string2, string4);
            return ale2;
        }
        finally {
...
lbl18: // 4 sources:
        do {
            akx.h().b("Fabric", "finish scanning in " + (SystemClock.elapsedRealtime() - var2_2) + " reading:" + var4_3);
            return var1_1;
            break;
        } while (true);
