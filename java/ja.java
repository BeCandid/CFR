...
public class ja {
    ...
    public byte[] a(String string2) throws UnsupportedEncodingException {
        return aox.a(super.a(new String(aox.a(string2.getBytes("UTF-8")), "UTF-8"), false).getBytes("UTF-8"));
    }

    public byte[] b(String string2) throws UnsupportedEncodingException {
        return aox.b(super.a(new String(aox.b(string2.getBytes("UTF-8")), "UTF-8"), true).getBytes("UTF-8"));
    }
}
