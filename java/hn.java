...
extends RecyclerView.OnScrollListener {
    ...
    public hn(LinearLayoutManager linearLayoutManager, hd hd2) {
        this.a = 10;
        this.b = 0;
        this.c = true;
        this.d = 0;
    ...
    public hn(LinearLayoutManager linearLayoutManager, hd hd2, int n2) {
        this.a = 10;
        this.b = 0;
        this.c = true;
        this.d = 0;
    ...
    public hn(LinearLayoutManager linearLayoutManager, hd hd2, int n2, int n3) {
        this.a = 10;
        this.b = 0;
        this.c = true;
        this.d = 0;
    ...
    public hn(StaggeredGridLayoutManager staggeredGridLayoutManager, hd hd2) {
        this.a = 10;
        this.b = 0;
        this.c = true;
        this.d = 0;
