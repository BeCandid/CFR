...
extends agd {
    ...
    ahh(ahk ahk2) {
        super(ahk2);
        this.b = new c((ahh)this, "health_monitor", this.y().W(), null);
        this.c = (ahh)this.new b("last_upload", 0);
        this.d = (ahh)this.new b("last_upload_attempt", 0);
        this.e = (ahh)this.new b("backoff", 0);
        this.f = (ahh)this.new b("last_delete_stale", 0);
        this.h = (ahh)this.new b("time_before_start", 10000);
        this.i = (ahh)this.new b("session_timeout", 1800000);
        this.j = (ahh)this.new a("start_new_session", true);
        this.k = (ahh)this.new b("last_pause_time", 0);
        this.l = (ahh)this.new b("time_active", 0);
        this.g = (ahh)this.new b("midnight_offset", 0);
    }
    ...
    public final class a {
        ...
        private void b() {
            ...
            this.d = true;
            this.e = ahh.this.o.getBoolean(this.b, this.c);
        }

        public void a(boolean bl2) {
            SharedPreferences.Editor editor = ahh.this.o.edit();
    ...
    public final class b {
        ...
        private void b() {
            ...
            this.d = true;
            this.e = ahh.this.o.getLong(this.b, this.c);
        }
    ...
    public final class c {
         ...
         * Enabled aggressive block sorting
         */
        private c(ahh ahh2, String string2, long l2) {
            this.b = ahh2;
            xz.a(string2);
            boolean bl2 = l2 > 0;
            xz.b(bl2);
        ...
        /* synthetic */ c(ahh ahh2, String string2, long l2,  var5_2) {
            super(ahh2, string2, l2);
        }
