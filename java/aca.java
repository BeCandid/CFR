...
public interface aca {
    ...
    extends aau {
         ...
         */
        public int hashCode() {
            int n2 = 31 * (31 * (527 + this.getClass().getName().hashCode()) + aat.a(this.b));
        ...
        public c b(aas aas2) throws IOException {
            block8 : do {
                ...
                switch (n2) {
                    ...
                    case 37: {
                        this.e = Float.valueOf((float)aas2.d());
                        continue block8;
                    }
                    case 41: 
                }
    ...
    extends aau {
        ...
        public d b(aas aas2) throws IOException {
            block4 : do {
                ...
                switch (n2) {
                    default: {
                        if (aaw.a(aas2, n2)) continue block4;
                    }
                    case 0: {
                        return this;
                    }
        ...
        public boolean equals(Object object) {
            ...
            d d2 = (d)object;
            if (aat.a(this.b, d2.b)) return true;
            return false;
        }

        public int hashCode() {
            return 31 * (527 + this.getClass().getName().hashCode()) + aat.a(this.b);
        }
    }
    ...
    extends aau {
        ...
        public e b(aas aas2) throws IOException {
            block35 : do {
                ...
                switch (n2) {
                    default: {
                        if (aaw.a(aas2, n2)) continue block35;
                    }
                    case 0: {
                        return this;
                    }
        ...
        public boolean equals(Object object) {
            ...
            if (!aat.a(this.c, e2.c)) {
                return false;
            }
            if (!aat.a(this.d, e2.d)) {
                return false;
            }
        ...
        public int hashCode() {
            int n2 = 31 * (527 + this.getClass().getName().hashCode());
            int n3 = this.b == null ? 0 : this.b.hashCode();
            int n4 = 31 * (31 * (31 * (n3 + n2) + aat.a(this.c)) + aat.a(this.d));
            ...
            int n50 = 31 * (31 * (n49 + n48) + aat.a(this.B));
    ...
    extends aau {
        ...
        public boolean equals(Object object) {
            ...
            f f2 = (f)object;
            if (!aat.a(this.b, f2.b)) {
                return false;
            }
            if (aat.a(this.c, f2.c)) return true;
            return false;
        }

        public int hashCode() {
            return 31 * (31 * (527 + this.getClass().getName().hashCode()) + aat.a(this.b)) + aat.a(this.c);
        }
    }
    ...
    extends aau {
        ...
        public g b(aas aas2) throws IOException {
            block9 : do {
                int n2 = aas2.a();
                switch (n2) {
                    default: {
                        if (aaw.a(aas2, n2)) continue block9;
                    }
                    case 0: {
                        return this;
                    }
                    ...
                    case 45: {
                        this.f = Float.valueOf((float)aas2.d());
                        continue block9;
                    }
                    case 49: 
                }
