...
public class ahk {
    ...
    ahk(age age2) {
        xz.a(age2);
        this.c = age2.a;
        this.n = age2.l((ahk)this);
        this.d = age2.a((ahk)this);
        ahh ahh2 = age2.b((ahk)this);
        ahh2.d();
        this.e = ahh2;
        ahd ahd2 = age2.c((ahk)this);
        ahd2.d();
        this.f = ahd2;
        ...
        this.k = age2.i((ahk)this);
        agu agu2 = age2.n((ahk)this);
        agu2.d();
        this.p = agu2;
        ahb ahb2 = age2.o((ahk)this);
        ahb2.d();
        this.r = ahb2;
        ags ags2 = age2.j((ahk)this);
        ags2.d();
        this.l = ags2;
        agq agq2 = age2.r((ahk)this);
        agq2.d();
        this.u = agq2;
        ahe ahe2 = age2.k((ahk)this);
        ahe2.d();
        this.m = ahe2;
        agg agg2 = age2.m((ahk)this);
        agg2.d();
        this.o = agg2;
        agf agf2 = age2.h((ahk)this);
        agf2.d();
        this.q = agf2;
        agl agl2 = age2.q((ahk)this);
        agl2.d();
        this.t = agl2;
        this.s = age2.p((ahk)this);
        this.j = age2.g((ahk)this);
        this.a = new ahx((ahk)this);
        agi agi2 = age2.e((ahk)this);
        agi2.d();
        this.h = agi2;
        ahj ahj2 = age2.f((ahk)this);
        ahj2.d();
        this.i = ahj2;
        zzw zzw2 = age2.d((ahk)this);
        zzw2.d();
        this.g = zzw2;
        if (this.B != this.C) {
    ...
    public static ahk a(Context context) {
        ...
        if (b != null) return b;
        reference var4_1 = ahk.class;
        // MONITORENTER : ahk.class
        if (b == null) {
            b = new age(context).a();
        }
        // MONITOREXIT : var4_1
    ...
    private aca.a[] a(String string2, aca.g[] arrg, aca.b[] arrb) {
        xz.a(string2);
        return this.x().a(string2, arrb, arrg);
    }

    private void b(agd agd2) {
        if (agd2 == null) {
            throw new IllegalStateException("Component not created");
        }
        if (!agd2.a()) {
    ...
    private void c(AppMetadata appMetadata) {
        ...
        xz.a(appMetadata);
        xz.a(appMetadata.b);
        agc agc2 = this.o().b(appMetadata.b);
        String string2 = this.e().b(appMetadata.b);
        if (agc2 == null) {
            agc agc3 = new agc((ahk)this, appMetadata.b);
            agc3.a(this.e().f());
            agc3.c(string2);
            agc2 = agc3;
            bl2 = bl3;
        } else {
            boolean bl4 = string2.equals((Object)agc2.e());
            bl2 = false;
            if (!bl4) {
                agc2.c(string2);
                agc2.a(this.e().f());
        ...
        if (!TextUtils.isEmpty((CharSequence)appMetadata.c) && !appMetadata.c.equals((Object)agc2.d())) {
            agc2.b(appMetadata.c);
            bl2 = bl3;
        }
        if (!TextUtils.isEmpty((CharSequence)appMetadata.l) && !appMetadata.l.equals((Object)agc2.f())) {
            agc2.d(appMetadata.l);
            bl2 = bl3;
        }
        if (appMetadata.f != 0 && appMetadata.f != agc2.l()) {
            agc2.d(appMetadata.f);
            bl2 = bl3;
        }
        if (!TextUtils.isEmpty((CharSequence)appMetadata.d) && !appMetadata.d.equals((Object)agc2.i())) {
            agc2.e(appMetadata.d);
            bl2 = bl3;
        }
        if (appMetadata.k != agc2.j()) {
            agc2.c(appMetadata.k);
            bl2 = bl3;
        }
        if (!TextUtils.isEmpty((CharSequence)appMetadata.e) && !appMetadata.e.equals((Object)agc2.k())) {
            agc2.f(appMetadata.e);
            bl2 = bl3;
        }
        if (appMetadata.g != agc2.m()) {
            agc2.e(appMetadata.g);
            bl2 = bl3;
        }
        if (appMetadata.i != agc2.n()) {
            agc2.a(appMetadata.i);
        } else {
            bl3 = bl2;
        }
        if (bl3) {
     ...
     * Enabled aggressive exception aggregation
     */
    void a(agv agv2, AppMetadata appMetadata) {
        long l2;
        this.y();
        this.a();
        xz.a(agv2);
        xz.a(appMetadata);
        xz.a(agv2.a);
        xz.b(agv2.a.equals((Object)appMetadata.b));
        aca.e e2 = new aca.e();
        e2.b = 1;
        e2.j = "android";
        e2.p = appMetadata.b;
        ...
        agc agc2 = this.o().b(appMetadata.b);
        if (agc2 == null) {
            agc2 = new agc((ahk)this, appMetadata.b);
            agc2.a(this.e().f());
            agc2.d(appMetadata.l);
            agc2.b(appMetadata.c);
            agc2.c(this.e().b(appMetadata.b));
            agc2.f(0);
            agc2.a(0);
            agc2.b(0);
            agc2.e(appMetadata.d);
        ...
        e2.v = agc2.c();
        e2.C = agc2.f();
        List<agn> list = this.o().a(appMetadata.b);
        e2.d = new aca.g[list.size()];
        for (int i2 = 0; i2 < list.size(); ++i2) {
            aca.g g2;
            e2.d[i2] = g2 = new aca.g();
            g2.c = ((agn)list.get((int)i2)).b;
            g2.b = ((agn)list.get((int)i2)).c;
            this.n().a(g2, ((agn)list.get((int)i2)).d);
        }
        try {
            l2 = this.o().b(e2);
        }
    ...
    void a(AppMetadata appMetadata, long l2) {
        agc agc2 = this.o().b(appMetadata.b);
        if (agc2 != null && agc2.d() != null && !agc2.d().equals((Object)appMetadata.c)) {
            this.f().z().a("New GMP App Id passed in. Removing cached database data.");
            this.o().g(agc2.b());
            agc2 = null;
        }
        if (agc2 != null && agc2.i() != null && !agc2.i().equals((Object)appMetadata.d)) {
            Bundle bundle = new Bundle();
            bundle.putString("_pv", agc2.i());
    ...
    void a(UserAttributeParcel userAttributeParcel, AppMetadata appMetadata) {
        ...
        agn agn2 = new agn(appMetadata.b, userAttributeParcel.b, userAttributeParcel.c, object);
        this.f().D().a("Setting user property", agn2.b, object);
        this.o().f();
        try {
            super.c(appMetadata);
            boolean bl2 = this.o().a(agn2);
            this.o().g();
            if (bl2) {
                this.f().D().a("User property set", agn2.b, agn2.d);
                return;
            }
            this.f().f().a("Too many unique user properties are set. Ignoring user property.", agn2.b, agn2.d);
    ...
    protected boolean b() {
        ...
        this.y();
        if (this.x == null) {
            boolean bl2 = this.n().i("android.permission.INTERNET") && this.n().i("android.permission.ACCESS_NETWORK_STATE") && ahi.a(this.q()) && agh.a(this.q());
            this.x = bl2;
    ...
    implements ags.b {
        ...
        /* synthetic */ a(ahk ahk2,  var2_2) {
            super(ahk2);
        }

        private long a(aca.b b2) {
        ...
        @Override
        public boolean a(long l2, aca.b b2) {
            xz.a(b2);
            if (this.c == null) {
            ...
            if (this.c.size() > 0 && super.a((aca.b)this.c.get(0)) != super.a(b2)) {
                return false;
            }
