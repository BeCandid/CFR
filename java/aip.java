...
extends ail {
    ...
    private static boolean a(aip aip2) {
        boolean bl2 = aip2.b instanceof Number;
        boolean bl3 = false;
        if (!bl2) return bl3;
        Number number = (Number)aip2.b;
    ...
    void a(Object object) {
        ...
        boolean bl2 = object instanceof Number || aip.b(object);
        aiy.a(bl2);
        this.b = object;
    }
    ...
    public boolean equals(Object object) {
        ...
        aip aip2 = (aip)object;
        if (this.b == null) {
            if (aip2.b == null) return true;
            return false;
        }
        if (aip.a((aip)this) && aip.a(aip2)) {
            if (this.b().longValue() == aip2.b().longValue()) return true;
            return false;
        }
        if (!(this.b instanceof Number)) return this.b.equals(aip2.b);
        if (!(aip2.b instanceof Number)) return this.b.equals(aip2.b);
        double d3 = this.b().doubleValue();
        if (d3 == (d2 = aip2.b().doubleValue())) return true;
