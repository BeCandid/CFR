...
extends arg<E> {
     ...
     */
    static {
        int n2 = asd.a.arrayIndexScale((Class)Object[].class);
        if (4 == n2) {
            e = 2 + a;
        } else {
            if (8 != n2) {
        ...
        d = asd.a.arrayBaseOffset((Class)Object[].class) + (32 << e - a);
    }
    ...
    protected final E a(E[] arrE, long l2) {
        return (E)asd.a.getObject(arrE, l2);
    }
    ...
    protected final E b(E[] arrE, long l2) {
        return (E)asd.a.getObjectVolatile(arrE, l2);
    }

    protected final void b(E[] arrE, long l2, E e2) {
        asd.a.putOrderedObject(arrE, l2, e2);
    }
