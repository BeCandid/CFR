...
extends IInterface {
    ...
    public boolean a(afb var1) throws RemoteException;
    ...
    implements afb {
        ...
        public boolean onTransact(int n2, Parcel parcel, Parcel parcel2, int n3) throws RemoteException {
            switch (n2) {
                ...
                case 15: {
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    boolean bl6 = this.a(afb$a.a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    int n9 = 0;
                    if (bl6) {
                        n9 = 1;
        ...
        implements afb {
             ...
             */
            @Override
            public boolean a(afb afb2) throws RemoteException {
                Parcel parcel = Parcel.obtain();
                Parcel parcel2 = Parcel.obtain();
                try {
                    parcel.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    IBinder iBinder = afb2 != null ? afb2.asBinder() : null;
