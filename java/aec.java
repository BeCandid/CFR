...
extends IInterface {
    public void a(CameraPosition var1) throws RemoteException;

    public static abstract class aec$a
    extends Binder
    implements aec {
        public static aec a(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof aec) {
                return (aec)iInterface;
            }
