...
extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int n2) {
        if (n2 >= 0) {
            final ig.a a2 = (ig.a)this.a.get(n2);
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener(){
                    ...
                    public void onClick(View view) {
                        if (!AppState.blurTaskCalledOnFlight) {
                            ...
                            new BlurTask(hc.this.b, 2131624285, a2.a).execute((Object[])new Void[0]);
                        }
                    }
                });
            }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int n2) {
        return (hc)this.new a(LayoutInflater.from((Context)viewGroup.getContext()).inflate(2130968750, null));
    }
    ...
    extends RecyclerView.ViewHolder {
        ...
        public a(View view) {
            ...
            this.b = (TextView)view.findViewById(2131624827);
        }
    }
