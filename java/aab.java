...
class aab {
    ...
    extends yv.a {
         ...
         * Enabled aggressive block sorting
         */
        protected a(byte[] arrby) {
            boolean bl2 = arrby.length == 25;
            int n2 = arrby.length;
            xz.b(bl2, new StringBuilder(55).append("cert hash data has incorrect length. length=").append(n2).toString());
        ...
        public boolean equals(Object object) {
            ...
            if (!(object instanceof yv)) {
                return false;
            }
            try {
                yv yv2 = (yv)object;
                if (yv2.b() != this.hashCode()) {
                    return false;
                }
                aag aag2 = yv2.a();
                if (aag2 == null) {
                ...
                byte[] arrby = (byte[])aah.a(aag2);
                return Arrays.equals((byte[])this.c(), (byte[])arrby);
            }
    ...
    extends a {
        ...
        byte[] c() {
            ...
            synchronized (c2) {
                ...
                if (arrby == null) {
                    arrby = this.d();
                    this.a = new WeakReference((Object)arrby);
                }
                return arrby;
            }
        }
    ...
    static final class d {
        ...
        static {
            a[] arra = new a[]{new c(a.a("0\u0082\u0004C0\u0082\u0003+\u00a0\u0003\u0002\u0001\u0002\u0002\t\u0000\u00c2\u00e0\u0087FdJ0\u008d0")){
