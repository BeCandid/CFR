...
extends agd {
    ...
    static /* synthetic */ byte[] a(ahe ahe2, HttpURLConnection httpURLConnection) throws IOException {
        return ahe2.a(httpURLConnection);
    }
    ...
    public void a(String string2, URL uRL, Map<String, String> map, a a2) {
        ...
        xz.a(uRL);
        xz.a(a2);
        this.v().b((Runnable)(ahe)this.new c(string2, uRL, null, map, a2));
    }
