...
extends IInterface {
    ...
    public boolean a(afh var1) throws RemoteException;
    ...
    public static abstract class afh$a
    extends Binder
    implements afh {
        public static afh a(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof afh) {
                return (afh)iInterface;
            }
        ...
        public boolean onTransact(int n2, Parcel parcel, Parcel parcel2, int n3) throws RemoteException {
            switch (n2) {
                ...
                case 19: {
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IPolygonDelegate");
                    boolean bl6 = this.a(afh$a.a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    int n10 = 0;
                    if (bl6) {
                        n10 = 1;
        ...
        implements afh {
             ...
             */
            @Override
            public boolean a(afh afh2) throws RemoteException {
                Parcel parcel = Parcel.obtain();
                Parcel parcel2 = Parcel.obtain();
                try {
                    parcel.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
                    IBinder iBinder = afh2 != null ? afh2.asBinder() : null;
