...
public class jb {
    ...
    public static AlertDialog.Builder a(Context context, String string2, String string3, String string4, String string5, int n2, boolean bl2, final in.a a2) {
    ...
    public static Spannable a(String string2) {
        ...
        if (n2 < -1 + string2.length()) {
            spannableString.setSpan((Object)new StyleSpan(1), n2, string2.length(), 33);
        }
        return spannableString;
    }

    public static Spannable a(String string2, int n2) {
        return jb.a(string2, n2, 0, 0);
    }
...
lbl39: // 2 sources:
    ...
    public static void a(Activity activity, RelativeLayout relativeLayout, List<String> list) {
        if (list == null || list.isEmpty()) {
            list = AppState.tags;
            rj.a((Throwable)new Exception("GROUP TAGS is null or empty"));
        }
        ...
        while (n3 < list.size()) {
            ...
            LinearLayout linearLayout2 = jb.a((Context)activity, (String)list.get(n3));
            ...
            while (linearLayout.getMeasuredWidth() + linearLayout2.getMeasuredWidth() < n2) {
                ...
                linearLayout2 = jb.a((Context)activity, (String)list.get(n3));
                linearLayout2.measure(0, 0);
            }
    ...
    public static void a(final Context context, int n2, final int n3) {
        ...
        ik.a().g((Map<String, String>)hashMap).b(Schedulers.io()).a(apv.a()).b(new apr<NetworkData>(){

            public void a(NetworkData networkData) {
                ix.a().a(new in.s(n3, string2));
                Toast.makeText((Context)context, (CharSequence)context.getResources().getString(2131230959), (int)0).show();
            }
    ...
    public static void a(final Context context, int n2, final int n3, final int n4) {
        ...
        hashMap.put((Object)"comment_id", (Object)Integer.toString((int)n3));
        hashMap.put((Object)"reason", (Object)string2);
        ik.a().f((Map<String, String>)hashMap).b(Schedulers.io()).a(apv.a()).b(new apr<NetworkData>(){

            public void a(NetworkData networkData) {
                ix.a().a(new in.l(n3, n4));
                Toast.makeText((Context)context, (CharSequence)context.getResources().getString(2131230956), (int)0).show();
            }
    ...
    public static void a(RecyclerView recyclerView, hf hf2) {
        RecyclerView.ViewHolder viewHolder = recyclerView.findViewHolderForAdapterPosition(-1 + hf2.getItemCount());
        if (viewHolder instanceof je) {
            View view = ((je)viewHolder).itemView;
            view.findViewById(2131624389).setVisibility(0);
            view.findViewById(2131624388).setVisibility(8);
        }
    }
        ...
        while (n6 < n5) {
            ...
            if (n7 + 1 < n2 && n2 <= (n4 += string2.length()) && string2.length() > 2) {
                ...
                if (arrayList.isEmpty()) {
                    ...
                    } else if (listPopupWindow.getHeight() != jb.a(90, editText.getContext())) {
                        listPopupWindow.setHeight(jb.a(90, editText.getContext()));
                    }
