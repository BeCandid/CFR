...
public class aap {
     ...
     */
    public aap(Context context, String string2) {
        this.b = context;
    ...
    private String b(String string2, String string3, String string4) {
    ...
    private void g(String string2) {
        ...
        try {
            if (!file.createNewFile() || this.a()) return;
            {
                ...
                InstanceIDListenerService.a((Context)this.b, (aap)this);
                return;
            }
        }
    ...
    public String a(String string2, String string3, String string4) {
        void var7_4 = this;
        synchronized (var7_4) {
            String string5 = super.b(string2, string3, string4);
    ...
    KeyPair a(String string2, long l2) {
        void var8_3 = this;
        synchronized (var8_3) {
            KeyPair keyPair = aam.a();
            SharedPreferences.Editor editor = this.a.edit();
            this.a(editor, string2, "|P|", aal.a(keyPair.getPublic().getEncoded()));
            this.a(editor, string2, "|K|", aal.a(keyPair.getPrivate().getEncoded()));
    ...
    public void a(String string2, String string3, String string4, String string5, String string6) {
        aap aap2 = this;
        synchronized (aap2) {
            String string7 = this.b(string2, string3, string4);
            SharedPreferences.Editor editor = this.a.edit();
