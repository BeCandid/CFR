...
extends IInterface {
    ...
    public static abstract class aax$a
    extends Binder
    implements aax {
        public static aax a(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof aax) {
                return (aax)iInterface;
            }
        ...
        public boolean onTransact(int n2, Parcel parcel, Parcel parcel2, int n3) throws RemoteException {
            switch (n2) {
                ...
                case 3: {
                    parcel.enforceInterface("com.google.android.gms.ads.identifier.internal.IAdvertisingIdService");
                    String string3 = this.a(parcel.readString());
                    parcel2.writeNoException();
        ...
        implements aax {
            ...
            @Override
            public String a(String string2) throws RemoteException {
                Parcel parcel = Parcel.obtain();
                Parcel parcel2 = Parcel.obtain();
                try {
                    parcel.writeInterfaceToken("com.google.android.gms.ads.identifier.internal.IAdvertisingIdService");
             ...
             */
            @Override
            public void a(String string2, boolean bl2) throws RemoteException {
                Parcel parcel = Parcel.obtain();
                Parcel parcel2 = Parcel.obtain();
                try {
                    parcel.writeInterfaceToken("com.google.android.gms.ads.identifier.internal.IAdvertisingIdService");
