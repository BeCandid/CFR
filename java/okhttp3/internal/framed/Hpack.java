...
final class Hpack {
    ...
    static final class Reader {
        ...
        private void adjustDynamicTableByteCount() {
            if (this.maxDynamicTableByteCount >= this.dynamicTableByteCount) return;
        ...
        private ByteString getName(int n2) {
            if (super.isStaticHeader(n2)) {
                return Hpack.access$000()[n2].name;
            }
            return this.dynamicTable[super.dynamicTableIndex((int)(n2 - Hpack.access$000().length))].name;
        }
        ...
        private void insertIntoDynamicTable(int n2, Header header) {
            ...
            if (n2 != -1) {
                n3 -= this.dynamicTable[super.dynamicTableIndex((int)n2)].hpackSize;
            }
            if (n3 > this.maxDynamicTableByteCount) {
                super.clearDynamicTable();
                return;
            }
            int n4 = super.evictToRecoverBytes(n3 + this.dynamicTableByteCount - this.maxDynamicTableByteCount);
            if (n2 == -1) {
                ...
                int n6 = n2 + (n4 + super.dynamicTableIndex(n2));
        ...
        private boolean isStaticHeader(int n2) {
            if (n2 >= 0 && n2 <= -1 + STATIC_HEADER_TABLE.length) {
                return true;
            }
            return false;
        }
        ...
        private void readIndexedHeader(int n2) throws IOException {
            ...
            int n3 = super.dynamicTableIndex(n2 - STATIC_HEADER_TABLE.length);
        ...
        private void readLiteralHeaderWithIncrementalIndexingIndexedName(int n2) throws IOException {
            super.insertIntoDynamicTable(-1, new Header(super.getName(n2), this.readByteString()));
        }
        ...
        private void readLiteralHeaderWithoutIndexingIndexedName(int n2) throws IOException {
            ByteString byteString = super.getName(n2);
        ...
        void headerTableSizeSetting(int n2) {
            this.headerTableSizeSetting = n2;
            this.maxDynamicTableByteCount = n2;
            super.adjustDynamicTableByteCount();
        }
    ...
    static final class Writer {
        ...
        void writeHeaders(List<Header> list) throws IOException {
            ...
            int n3 = list.size();
            while (n2 < n3) {
                ByteString byteString = ((Header)list.get((int)n2)).name.toAsciiLowercase();
                Integer n4 = (Integer)NAME_TO_FIRST_INDEX.get((Object)byteString);
                if (n4 != null) {
                    this.writeInt(1 + n4, 15, 0);
                    this.writeByteString(((Header)list.get((int)n2)).value);
                } else {
