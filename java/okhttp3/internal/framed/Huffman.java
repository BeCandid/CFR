...
class Huffman {
     ...
     */
    byte[] decode(byte[] var1) throws IOException {
        var2_2 = new ByteArrayOutputStream();
        var3_3 = this.root;
        var4_4 = 0;
        var5_5 = 0;
        for (var6_6 = 0; var6_6 < var1.length; ++var6_6) {
            var4_4 = 255 & var1[var6_6] | var4_4 << 8;
            var5_5 += 8;
            while (var5_5 >= 8) {
                var9_7 = 255 & var4_4 >>> var5_5 - 8;
                if (Node.access$000(var3_3 = Node.access$000(var3_3)[var9_7]) == null) {
                    var2_2.write(Node.access$100(var3_3));
                    var5_5 -= Node.access$200(var3_3);
                    var3_3 = this.root;
                    continue;
                }
                var5_5 -= 8;
        ...
        ** GOTO lbl22
lbl19: // 1 sources:
        var2_2.write(Node.access$100(var8_8));
        var5_5 -= Node.access$200(var8_8);
        var3_3 = this.root;
lbl22: // 2 sources:
        if (var5_5 <= 0) return var2_2.toByteArray();
        var7_9 = 255 & var4_4 << 8 - var5_5;
        var8_8 = Node.access$000(var3_3)[var7_9];
        if (Node.access$000(var8_8) != null) return var2_2.toByteArray();
        if (Node.access$200(var8_8) <= var5_5) ** GOTO lbl19
