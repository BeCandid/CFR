...
public class iy {
    ...
    public static iy a() {
        if (b != null) return b;
        reference var1 = iy.class;
        // MONITORENTER : iy.class
        if (b == null) {
            b = new iy();
        }
        // MONITOREXIT : var1
    ...
    public static void a(Context context, String string2, String string3) {
        Intent intent = iy.a(string3, iy.b(string2));
        try {
    ...
    public static void b(Context context, String string2, String string3) {
        ...
        iy.a(context, string2, string3, shareDialog);
    }
