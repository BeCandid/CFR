...
extends aoy {
     ...
     */
    public aox(int n2, byte[] arrby, boolean bl2) {
        int n3 = arrby == null ? 0 : arrby.length;
        super(3, 4, n2, n3);
        this.h = f;
        if (arrby != null) {
            if (this.e(arrby)) {
                String string2 = aoz.a(arrby);
    ...
    public static byte[] a(byte[] arrby, boolean bl2, boolean bl3, int n2) {
        ...
        aox aox2 = bl2 ? new aox(bl3) : new aox(0, a, bl3);
        long l2 = aox2.f(arrby);
        if (l2 > (long)n2) {
     ...
     */
    @Override
    void a(byte[] arrby, int n2, int n3, aoy.a a2) {
        if (a2.f) {
            return;
        }
        if (n3 < 0) {
     ...
     */
    @Override
    void b(byte[] arrby, int n2, int n3, aoy.a a2) {
        if (a2.f) {
            return;
        }
        if (n3 < 0) {
