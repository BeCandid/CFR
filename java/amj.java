...
extends ThreadPoolExecutor {
    ...
    <T extends Runnable,  extends amc,  extends amh> amj(int n2, int n3, long l2, TimeUnit timeUnit, DependencyPriorityBlockingQueue<T> dependencyPriorityBlockingQueue, ThreadFactory threadFactory) {
    ...
    public static <T extends Runnable,  extends amc,  extends amh> amj a(int n2, int n3) {
        return new amj(n2, n3, 1, TimeUnit.SECONDS, new DependencyPriorityBlockingQueue(), new a(10));
    }

    protected void afterExecute(Runnable runnable, Throwable throwable) {
        amk amk2 = (amk)runnable;
        amk2.b(true);
        amk2.a(throwable);
        this.b().d();
    ...
    protected <T> RunnableFuture<T> newTaskFor(Runnable runnable, T t2) {
        return new amg<T>(runnable, t2);
    }

    protected <T> RunnableFuture<T> newTaskFor(Callable<T> callable) {
        return new amg<T>(callable);
    }
