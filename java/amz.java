...
final class amz {
    ...
    public static X509Certificate[] a(X509Certificate[] arrx509Certificate, anf anf2) throws CertificateException {
        X509Certificate x509Certificate;
        int n2;
        LinkedList linkedList = new LinkedList();
        boolean bl2 = anf2.a(arrx509Certificate[0]);
        boolean bl3 = false;
        if (bl2) {
            bl3 = true;
        }
        ...
        for (n2 = 1; n2 < arrx509Certificate.length; ++n2) {
            if (anf2.a(arrx509Certificate[n2])) {
                bl3 = true;
            }
            if (!amz.a(arrx509Certificate[n2], arrx509Certificate[n2 - 1])) break;
            linkedList.add((Object)arrx509Certificate[n2]);
        }
        if ((x509Certificate = anf2.b(arrx509Certificate[n2 - 1])) != null) {
