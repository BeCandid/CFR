...
public final class aas {
    ...
    private aas(byte[] arrby, int n2, int n3) {
        this.a = arrby;
        this.b = n2;
        this.c = n2 + n3;
        this.e = n2;
    ...
    public static aas a(byte[] arrby) {
        return aas.a(arrby, 0, arrby.length);
    }

    public static aas a(byte[] arrby, int n2, int n3) {
        return new aas(arrby, n2, n3);
    }
    ...
    public void a(aau aau2) throws IOException {
        int n2 = this.j();
        if (this.h >= this.i) {
            throw zzami.g();
        }
    ...
    public String i() throws IOException {
        ...
        String string2 = new String(this.a, this.e, n2, aat.a);
        this.e = n2 + this.e;
        return string2;
    }
