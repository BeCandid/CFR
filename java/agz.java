...
public final class agz {
    ...
    public static final class a<V> {
        ...
        private a(String string2, abr<V> abr2, V v2) {
            xz.a(abr2);
            this.b = abr2;
            this.a = v2;
            this.c = string2;
        ...
        static a<Integer> a(String string2, int n2, int n3) {
            return new a<Integer>(string2, abr.a(string2, n3), n2);
        }
        ...
        static a<Long> a(String string2, long l2, long l3) {
            return new a<Long>(string2, abr.a(string2, l3), l2);
        }
        ...
        static a<String> a(String string2, String string3, String string4) {
            return new a<String>(string2, abr.a(string2, string4), string3);
        }
        ...
        static a<Boolean> a(String string2, boolean bl2, boolean bl3) {
            return new a<Boolean>(string2, abr.a(string2, bl3), bl2);
        }
