...
public final class ej {
    ...
    public static MenuItem a(MenuItem menuItem, e e2) {
        if (menuItem instanceof cl) {
            return ((cl)menuItem).setSupportOnActionExpandListener(e2);
        }
        return a.a(menuItem, e2);
    }
    ...
    implements d {
        ...
        @Override
        public MenuItem a(MenuItem menuItem, e e2) {
            return menuItem;
        }
    ...
    extends b {
        ...
        @Override
        public MenuItem a(MenuItem menuItem, final e e2) {
            if (e2 == null) {
                return el.a(menuItem, null);
            }
            return el.a(menuItem, new el.b(){

                @Override
                public boolean a(MenuItem menuItem) {
                    return e2.onMenuItemActionExpand(menuItem);
                }

                @Override
                public boolean b(MenuItem menuItem) {
                    return e2.onMenuItemActionCollapse(menuItem);
                }
            });
        }
    ...
    static interface d {
        ...
        public MenuItem a(MenuItem var1, e var2);
