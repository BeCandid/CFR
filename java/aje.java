...
public final class aje {
    public static ail a(ajv ajv2) throws JsonParseException {
        boolean bl2 = true;
        ajv2.f();
        bl2 = false;
        try {
            ail ail2 = ajs.X.b(ajv2);
            return ail2;
        }
    ...
    public static void a(ail ail2, ajw ajw2) throws IOException {
        ajs.X.a(ajw2, ail2);
    }

    static final class aje$a
    extends Writer {
