...
public final class abh {
    ...
    abh(Context context) {
        ...
        this.f = yf2.a("firebase_database_url");
        this.h = yf2.a("google_storage_bucket");
        this.g = yf2.a("gcm_defaultSenderId");
        this.d = yf2.a("google_api_key");
        String string2 = zb.a(context);
        if (string2 == null) {
            string2 = yf2.a("google_app_id");
        }
    ...
    abh(String string2, boolean bl2) {
     ...
     * Enabled aggressive block sorting
     */
    abh(String string2, boolean bl2, String string3, String string4, String string5) {
        this.c = string2;
        this.d = null;
        this.e = Status.a;
        this.i = bl2;
    ...
    public static Status a(Context context) {
        Object object;
        xz.a(context, (Object)"Context must not be null.");
        Object object2 = object = a;
        synchronized (object2) {
            if (b != null) return abh.b.e;
            b = new abh(context);
            return abh.b.e;
        }
    }
    ...
    public static Status a(Context context, String string2, boolean bl2) {
        Object object;
        xz.a(context, (Object)"Context must not be null.");
        xz.a(string2, (Object)"App ID must be nonempty.");
        Object object2 = object = a;
        synchronized (object2) {
            if (b != null) {
                return b.a(string2);
            }
            b = new abh(string2, bl2);
            return abh.b.e;
        }
    }

    public static String a() {
        return abh.b((String)"getGoogleAppId").c;
    }
     ...
     * Enabled aggressive exception aggregation
     */
    private static abh b(String string2) {
        Object object;
        Object object2 = object = a;
        synchronized (object2) {
            if (b != null) return b;
    ...
    public static boolean b() {
        return abh.b((String)"isMeasurementExplicitlyDisabled").j;
    }
