...
implements Closeable {
    private static final Logger b = Logger.getLogger((String)aly.class.getName());
    int a;
    ...
    private static void a(File file) throws IOException {
        ...
        RandomAccessFile randomAccessFile = aly.b(file2);
        randomAccessFile.setLength(4096);
        randomAccessFile.seek(0);
        byte[] arrby = new byte[16];
        aly.a(arrby, 4096, 0, 0, 0);
    ...
    private void e() throws IOException {
        ...
        int n2 = aly.a(this.g, 8);
        int n3 = aly.a(this.g, 12);
        this.e = this.a(n2);
        this.f = this.a(n3);
    }
    ...
    public void a(c c2) throws IOException {
        ...
        synchronized (var7_2) {
            ...
            do {
                ...
                if (n3 >= this.d) break;
                a a2 = super.a(n2);
                c2.a(new b((aly)this, a2, null), a2.c);
    ...
    extends InputStream {
        ...
        private b(aly aly2, a a2) {
            this.a = aly2;
            this.b = aly2.b(4 + a2.b);
            this.c = a2.c;
        }

        /* synthetic */ b(aly aly2, a a2,  var3_2) {
            super(aly2, a2);
        }
