...
extends IInterface {
    public void a(PointOfInterest var1) throws RemoteException;

    public static abstract class aer$a
    extends Binder
    implements aer {
        public static aer a(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof aer) {
                return (aer)iInterface;
            }
        ...
        public boolean onTransact(int n2, Parcel parcel, Parcel parcel2, int n3) throws RemoteException {
            ...
            PointOfInterest pointOfInterest = parcel.readInt() != 0 ? PointOfInterest.CREATOR.a(parcel) : null;
