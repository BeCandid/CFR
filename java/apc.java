...
public class apc {
     ...
     */
    public apc a(byte by2, byte by3) {
        if (this.a != 0) {
            return this;
        }
    ...
    public apc a(double d2, double d3) {
        if (this.a != 0) {
            return this;
        }
    ...
    public apc a(float f2, float f3) {
        if (this.a != 0) {
            return this;
        }
    ...
    public apc a(Object object, Object object2) {
     ...
     * Enabled aggressive block sorting
     */
    public apc a(Object object, Object object2, Comparator<?> comparator) {
     ...
     * Enabled aggressive block sorting
     */
    public apc a(short s2, short s3) {
        if (this.a != 0) {
            return this;
        }
     ...
     * Enabled aggressive block sorting
     */
    public apc a(boolean bl2, boolean bl3) {
        if (this.a != 0 || bl2 == bl3) {
            return this;
        }
        if (!bl2) {
     ...
     */
    public apc a(byte[] arrby, byte[] arrby2) {
        int n2 = -1;
        if (this.a != 0) {
            return this;
        }
     ...
     * Lifted jumps to return sites
     */
    public apc a(char[] arrc, char[] arrc2) {
        int n2 = -1;
        if (this.a != 0) {
            return this;
        }
     ...
     * Lifted jumps to return sites
     */
    public apc a(double[] arrd, double[] arrd2) {
        int n2 = -1;
        if (this.a != 0) {
            return this;
        }
     ...
     * Lifted jumps to return sites
     */
    public apc a(float[] arrf, float[] arrf2) {
        int n2 = -1;
        if (this.a != 0) {
            return this;
        }
     ...
     * Lifted jumps to return sites
     */
    public apc a(int[] arrn, int[] arrn2) {
        int n2 = -1;
        if (this.a != 0) {
            return this;
        }
     ...
     * Lifted jumps to return sites
     */
    public apc a(long[] arrl, long[] arrl2) {
        int n2 = -1;
        if (this.a != 0) {
            return this;
        }
     ...
     * Lifted jumps to return sites
     */
    public apc a(Object[] arrobject, Object[] arrobject2, Comparator<?> comparator) {
        int n2 = -1;
        if (this.a != 0) {
            return this;
        }
     ...
     * Lifted jumps to return sites
     */
    public apc a(short[] arrs, short[] arrs2) {
        int n2 = -1;
        if (this.a != 0) {
            return this;
        }
     ...
     * Lifted jumps to return sites
     */
    public apc a(boolean[] arrbl, boolean[] arrbl2) {
        int n2 = -1;
        if (this.a != 0) {
            return this;
        }
