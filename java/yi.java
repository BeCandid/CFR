...
public abstract class yi<T extends IInterface> {
    ...
    protected yi(Context context, Looper looper, int n2, b b2, c c2, String string2) {
        this(context, looper, yq.a(context), aaa.b(), n2, xz.a(b2), xz.a(c2), string2);
    }

    protected yi(Context context, Looper looper, yq yq2, aaa aaa2, int n2, b b2, c c2, String string2) {
        this.i = xz.a(context, (Object)"Context must not be null");
        this.j = xz.a(looper, (Object)"Looper must not be null");
        this.k = xz.a(yq2, (Object)"Supervisor must not be null");
        this.l = xz.a(aaa2, (Object)"API availability must not be null");
        this.a = (yi)this.new d(looper);
        this.w = n2;
        this.u = b2;
        this.v = c2;
        this.x = string2;
...
lbl18: // 3 sources:
    ...
    protected void a(int n2, Bundle bundle, int n3) {
        this.a.sendMessage(this.a.obtainMessage(5, n3, -1, (Object)(yi)this.new k(n2, bundle)));
    }

    protected void a(int n2, IBinder iBinder, Bundle bundle, int n3) {
        this.a.sendMessage(this.a.obtainMessage(1, n3, -1, (Object)(yi)this.new j(n2, iBinder, bundle)));
    }
    ...
    public void a(f f2) {
        this.p = xz.a(f2, (Object)"Connection progress callbacks cannot be null.");
        super.b(2, null);
    }
     ...
     * Lifted jumps to return sites
     */
    public void a(yt var1, Set<Scope> var2_2) {
        try {
            var7_3 = this.o();
...
lbl-1000: // 1 sources:
        {
            this.o.a((yw)new g((yi)this, this.b.get()), var8_4);
            // MONITOREXIT : var15_6
            return;
        }
lbl-1000: // 1 sources:
    ...
    public final T r() throws DeadObjectException {
        ...
        synchronized (object2) {
            ...
            xz.a(bl2, (Object)"Client is connected but service is null");
            T t2 = this.q;
            return t2;
        }
    }
    ...
    extends Handler {
        ...
        public void handleMessage(Message message) {
            if (yi.this.b.get() != message.arg1) {
                if (super.b(message)) {
                    super.a(message);
                }
                return;
            }
            if (!(message.what != 1 && message.what != 5 || yi.this.c())) {
                super.a(message);
                return;
            }
            if (message.what == 3) {
                ...
                yi.this.p.a(connectionResult);
                yi.this.a(connectionResult);
                return;
            }
            if (message.what == 4) {
                yi.this.b(4, (T)null);
                if (yi.this.u != null) {
                    yi.this.u.a(message.arg2);
                }
                yi.this.a(message.arg2);
                yi.this.a(4, 1, (T)null);
                return;
            }
            if (message.what == 2 && !yi.this.b()) {
                super.a(message);
                return;
            }
            if (super.b(message)) {
    ...
    public abstract class e<TListener> {
        ...
        public void d() {
            ArrayList arrayList;
            this.e();
            ArrayList arrayList2 = arrayList = yi.this.r;
            synchronized (arrayList2) {
                yi.this.r.remove((Object)this);
                return;
            }
        }
    ...
    implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            Object object;
            xz.a(iBinder, (Object)"Expecting a valid IBinder");
            Object object2 = object = yi.this.n;
            synchronized (object2) {
                yi.this.o = yx.a.a(iBinder);
            }
            yi.this.a(0, null, this.b);
        }
        ...
        public void onServiceDisconnected(ComponentName componentName) {
            ...
            yi.this.a.sendMessage(yi.this.a.obtainMessage(4, this.b, 1));
        }
    }
    ...
    implements f {
        ...
        public void a(ConnectionResult connectionResult) {
            if (connectionResult.b()) {
                yi.this.a(null, yi.this.u());
                return;
            } else {
                if (yi.this.v == null) return;
                {
                    yi.this.v.a(connectionResult);
                    return;
                }
            }
        }
    ...
    extends a {
        ...
        protected boolean a() {
            ...
            if (!yi.this.g().equals((Object)string2)) {
                String string3 = String.valueOf((Object)yi.this.g());
                ...
                Object t2 = yi.this.a(this.e);
                if (t2 == null || !yi.this.a(2, 3, (T)t2)) return false;
                {
                    Bundle bundle = yi.this.q();
                    if (yi.this.u == null) return true;
                    {
                        yi.this.u.a(bundle);
                    }
                    return true;
    ...
    extends a {
        ...
        @Override
        protected boolean a() {
            yi.this.p.a(ConnectionResult.a);
            return true;
        }
    }
