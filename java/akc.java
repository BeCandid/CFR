...
implements akb {
    private static final Logger a = Logger.getLogger((String)akc.class.getName());
    ...
    public akc(ajz ajz2) {
        super("/com/google/i18n/phonenumbers/data/PhoneNumberMetadataProto", ajz2);
    }

    public akc(String string2, ajz ajz2) {
     ...
     */
    private static akf.c a(ObjectInputStream objectInputStream) {
        akf.c c2 = new akf.c();
        c2.a(aka.a(objectInputStream, 16384));
        try {
     ...
     */
    @Override
    public akf.b a(int n2) {
        Map<Integer, akf.b> map;
        Map<Integer, akf.b> map2 = map = this.c;
        synchronized (map2) {
            List list;
            if (!this.c.containsKey((Object)n2) && (list = (List)ajy.a().get((Object)n2)).size() == 1 && "001".equals(list.get(0))) {
                this.a("001", n2);
            }
            return (akf.b)this.c.get((Object)n2);
        }
    }
     ...
     */
    @Override
    public akf.b a(String string2) {
        Map<String, akf.b> map;
        Map<String, akf.b> map2 = map = this.b;
        synchronized (map2) {
            if (!this.b.containsKey((Object)string2)) {
                this.a(string2, 0);
            }
            return (akf.b)this.b.get((Object)string2);
        }
    }
