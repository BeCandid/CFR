...
extends ArrayAdapter<Group> {
    ...
    public View getView(int n2, View view, ViewGroup viewGroup) {
        View view2 = view;
        if (view2 == null) {
            view2 = ((Activity)this.getContext()).getLayoutInflater().inflate(2130968690, viewGroup, false);
            view2.findViewById(2131624502).setVisibility(8);
            view2.findViewById(2131624504).setVisibility(8);
        }
        Group group = (Group)this.getItem(n2);
        ((TextView)view2.findViewById(2131624503)).setText((CharSequence)group.group_name);
        view2.findViewById(2131624501).setVisibility(8);
        return view2;
    }
