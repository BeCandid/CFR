...
implements X509TrustManager {
    ...
    public ane(anf anf2, and and2) {
        this.b = super.a(anf2);
        this.c = anf2;
        this.d = and2.d();
        for (String string2 : and2.c()) {
    ...
    private void a(X509Certificate[] arrx509Certificate) throws CertificateException {
        if (this.d != -1 && System.currentTimeMillis() - this.d > 15552000000L) {
            ...
            X509Certificate[] arrx509Certificate2 = amz.a(arrx509Certificate, this.c);
