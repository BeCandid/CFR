...
extends agd {
    ...
    static String a(boolean bl2, Object object) {
        ...
        String string5 = ahd.a(AppMeasurement.class.getCanonicalName());
        String string6 = ahd.a(ahk.class.getCanonicalName());
        ...
        while (n3 < n2) {
            ...
            if (!stackTraceElement.isNativeMethod() && (string7 = stackTraceElement.getClassName()) != null && ((string8 = ahd.a(string7)).equals((Object)string5) || string8.equals((Object)string6))) {
    ...
    static String a(boolean bl2, String string2, Object object, Object object2, Object object3) {
        ...
        String string3 = ahd.a(bl2, object);
        String string4 = ahd.a(bl2, object2);
        String string5 = ahd.a(bl2, object3);
    ...
    public void a(int n2, String string2, Object object, Object object2, Object object3) {
        ...
        char c3 = this.b;
        long l2 = this.c;
        String string4 = String.valueOf((Object)ahd.a(true, string2, object, object2, object3));
        ...
        zzw2.a(new Runnable(){
            ...
            public void run() {
                ahh ahh2 = ahd.this.n.e();
                if (!ahh2.a() || ahh2.b()) {
                    ahd.this.a(6, "Persisted config not initialized . Not logging error/warn.");
                    return;
                }
                ahh2.b.a(string5);
            }
    ...
    protected void a(int n2, boolean bl2, boolean bl3, String string2, Object object, Object object2, Object object3) {
        if (!bl2 && this.a(n2)) {
            this.a(n2, ahd.a(false, string2, object, object2, object3));
        }
        if (!bl3 && n2 >= 5) {
    ...
    public class a {
        ...
        public void a(String string2) {
            ahd.this.a(this.b, this.c, this.d, string2, null, null, null);
        }

        public void a(String string2, Object object) {
            ahd.this.a(this.b, this.c, this.d, string2, object, null, null);
        }

        public void a(String string2, Object object, Object object2) {
            ahd.this.a(this.b, this.c, this.d, string2, object, object2, null);
        }

        public void a(String string2, Object object, Object object2, Object object3) {
            ahd.this.a(this.b, this.c, this.d, string2, object, object2, object3);
        }
    }
